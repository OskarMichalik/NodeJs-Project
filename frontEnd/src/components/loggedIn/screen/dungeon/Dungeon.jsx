...
import dark_elf from "../../../../assets/dark_elf.png";
import chest from "../../../../assets/treasure_chest.png";
import bandit_boss from "../../../../assets/bandit_boss.png";
import dark_elf_boss from "../../../../assets/dark_elf_boss.png";

import cave_full from "../../../../assets/cave_full_pixel.png";
import forest_full from "../../../../assets/forest_full_pixel.png";
...
export default function Dungeon({ setLocation, location }) {
  ...
  const floor = useSelector((state) =>
    location === "cave" ? state.profile.cave_floor : state.profile.forest_floor
  );
  ...
  async function getExperience() {
    ...
    const lvlup = geinedXP + level >= 100;

    dispatch(updateLevel(geinedXP,lvlup));
