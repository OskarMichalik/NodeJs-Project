...
import woodBackground from "../../../assets/wood.png";
import map from "../../../assets/map.png";
import forest from "../../../assets/forest_pixel.png";
import cave from "../../../assets/cave_pixel.png";
import inn from "../../../assets/inn_pixel.png";
import forest_selected from "../../../assets/forest_pixel_selected.png";
import cave_selected from "../../../assets/cave_pixel_selected.png";
import inn_selected from "../../../assets/inn_pixel_selected.png";
...
export default function GameScreen({ location, setLocation, setDeaths }) {
  ...
  return (
    <div className={classes.gameScreenDiv}>
      ...
      {location === "playerDead" && (
        <PlayerIsDead setLocation={setLocation} setDeaths={setDeaths} />
      )}
    </div>
  );
}
