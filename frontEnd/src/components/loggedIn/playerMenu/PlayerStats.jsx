...
import knight_small from "../../../assets/knight_small.png";
import ranger_small from "../../../assets/ranger_small.png";
import mage_small from "../../../assets/mage_small.png";
...
export default function PlayerStats({ setSelectedPortrait }) {
  ...
  const healthPercentage = Math.ceil((userHealth / userMaxHealth) * 100);
  ...
  return (
    <div className={classes.playerStatsDiv}>
      ...
      <div className={classes.remainingAbilitiesDiv}>
        <div
          className={classes.characterRemainingAbilities}
          onClick={() => changeSelectedImage(0)}
        >
